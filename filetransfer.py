...
class Main:
    def __init__(self):
        ...
        self.pic = PhotoImage(file='E:\Python Semester 2\Assignment\File Transfer\Images\cover.png')
    ...
    def user_store(self):
        with open('E:\\Python Semester 2\\Assignment\\File Transfer\\users.csv', 'a', newline='') as f:
            writer = csv.writer(f)
    ...
    def download_window(self):
        ...
        self.flist = os.listdir("E:\Python Semester 2\Assignment\File Transfer\Server")
    ...
    def recieve_file(self):
        ...
        while True:
            ...
            with open(f"E:\Python Semester 2\Assignment\File Transfer\Client\{rec_name}.txt", 'wb') as f:
                f.write(received)
            f.close()
